...
class PeopleSeeder extends Seeder
{
    public function run()
    {
        DB::table('people')->insert([
            ...
            ['id' => 3, 'name' => 'Takahashi, Rie', 'image_url' => 'https://cdn.myanimelist.net/images/voiceactors/3/78665.jpg'],
            ...
            ['id' => 6, 'name' => 'Hayami, Saori', 'image_url' => 'https://cdn.myanimelist.net/images/voiceactors/1/84514.jpg'],
